            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="border-t border-border/50 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex items-center gap-6 text-[11px] md:text-xs font-bold tracking-wider">
                        ...
                        {settings?.twitterUrl && (
                            <a href={settings.twitterUrl} target="_blank" rel="noreferrer" className="flex items-center justify-center w-8 h-8 rounded-full bg-[#333333] hover:bg-[#0f2256] hover:text-white dark:hover:bg-accent dark:hover:text-white transition-all text-white" aria-label="Twitter">
